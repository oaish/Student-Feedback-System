...
<form method="post" action="">
      ...
      <div class="card">
        <div class="card-header">
          <h3 class="card-title">View  Test series Topics</h3>
        </div>
        <div class="card-body">
<table id="example"  class="table table-striped table-bordered" >
	...
	if($_GET['qtype'] == "All")
	{
		$sql = $sql . " AND qpaper_status='Approved'";
	}
...
<?php
		...
		echo "<td style='width:70px;'><a href='testseriestopicadmin.php?testseriestopicid=$rs[0]' class='btn btn-primary' >View<br>More</a></td>";
		echo "</tr>";
	}
	?>
	</tbody>
