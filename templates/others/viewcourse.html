...
<table id="myTable"  class="table table-striped table-bordered" >
	...
	while($rs = mysqli_fetch_array($qsql))
	{
		echo "<tr>
				...
				<td><a href='course.php?editid=$rs[0]' class='btn btn-info'>Edit</a> | <a href='viewcourse.php?delid=$rs[0]' onclick='return validatedel()'  class='btn btn-danger' >Delete</a></td>
			</tr>";
	}
	?>
	</tbody>
