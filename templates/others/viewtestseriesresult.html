...
<form method="post" action="">
      ...
      <div class="card">
        <div class="card-header">
          <h3 class="card-title">View Test Series Result - <?php echo $rstestseriestopic['testseries_topic']; ?></h3>
        </div>
        <div class="card-body">
<table id="myTable"  class="table table-striped table-bordered" >
	...
	<tbody>
	<?php
	$sql ="SELECT * FROM testseries_result WHERE testseriestopicid='$_GET[testseriestopicid]' GROUP BY testseriestopicid,studentid";
...
$sqlqz ="SELECT * FROM testseries_result WHERE testseriestopicid='$rs[testseriestopicid]' AND studentid='$rs[studentid]' and selectedanswer = correctanswer ";
...
$sqltestseries_result ="SELECT * FROM testseries_result WHERE testseriestopicid='$rs[testseriestopicid]' AND studentid='$rs[studentid]'";
