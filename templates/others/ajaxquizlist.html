...
<form method="post" action="" onsubmit="return confirmvalidation1()" enctype="multipart/form-data">
      ...
      <div class="card">
        <div class="card-header">
          <h3 class="card-title">View Quiz Questions</h3>
        </div>
        <div class="card-body">
<?php
...
<table class="table table-striped table-bordered" >
	<tbody>
	<tr>
		<th>Quiz Topic</th><td><?php echo $rsedit['quiz_topic']; ?></td>
	</tr>
	<tr>
	...
	<tr>
		<th>Number of Questions</th><td>
			<?php
			$sqlqz ="SELECT * FROM quiz WHERE quiztopicid='$_GET[quiztopicid]'";
...
<input type="hidden" name="edquizid" id="edquizid" value="<?php echo $rsqz['quizid']; ?>">
<div class="row">
	<div class="col-md-12">
