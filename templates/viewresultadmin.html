...
<table id="myTable"  class="table table-striped table-bordered" >
	...
	<tbody>
	<?php
	$sql ="SELECT * FROM quiz_result GROUP BY studentid";
...
<?php echo $rsstudent['studentclass']; ?> (<?php echo $rsstudent['section']; ?>)				
		...
		echo "<td>$totalmarks</td>";
			...
			echo "<td><a href='quiz_result.php?quiztopicid=$rs[quiztopicid]&studentid=$rs[studentid]' class='btn btn-info'>View</a> </td>";
			echo "</tr>";
	}
	?>
	</tbody>
